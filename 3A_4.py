...
for cluster in all clusters:
    label them according to the clusters they fall InterruptedError

    trace them back to the original data

matplotlib plot showing all points in data colored by their clusters